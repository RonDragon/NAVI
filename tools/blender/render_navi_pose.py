...
poses={'Idle':(60,15),'Wave':(45,15),'HappyJump':(30,15),'TailWag':(35,135),'Listen':(45,0),'Sleep':(60,35)}
...
for name in names:
    ...
    cam.location=target+Vector((2.8*math.sin(angle),-2.8*math.cos(angle),0))
    ...
    scene.render.filepath=str(ROOT/'renders'/('navi-v1-'+name.lower()+'.png'))
